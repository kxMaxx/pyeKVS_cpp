...
// pyeKVScpp.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CpyeKVScppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CpyeKVScppApp-Erstellung

CpyeKVScppApp::CpyeKVScppApp()
{
	// TODO: Hier Code zur Konstruktion einfügen
	// Alle wichtigen Initialisierungen in InitInstance positionieren
}

// Das einzige CpyeKVScppApp-Objekt

CpyeKVScppApp theApp;

// CpyeKVScppApp-Initialisierung

BOOL CpyeKVScppApp::InitInstance()
{
